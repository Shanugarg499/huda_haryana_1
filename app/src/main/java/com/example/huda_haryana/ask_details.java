            ...
            public void onClick(View v) {
                if(!t4.getText().toString().equals("--Select--") && !t1.getText().toString().equals("") && !t6.getText().toString().equals("") && !t7.getText().toString().equals(""))
                {
                    ...
                    dbr.child(String.valueOf(System.currentTimeMillis())).setValue(new order_to_database(t1.getText().toString(), t2.getText().toString(),
                            ...
                            t7.getText().toString(), t8.getText().toString(), t9.getText().toString(), new SimpleDateFormat("yyyy-MM-dd", Locale.getDefault()).format(new Date()), String.valueOf(System.currentTimeMillis())));
